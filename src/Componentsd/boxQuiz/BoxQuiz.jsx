...
const BoxQuiz = () => {
                ...
                if (timeCount <= 0) {
                    ...
                    for (let i = 0; i <= options.current.children.length - 1; i++) {
                        ...
                        if (options.current.children[i].textContent == context.questions[countQue].answer) {
                            options.current.children[i].insertAdjacentHTML("beforeend", "<i></i>");
        ...
        <>
            <section className="container-boxQuiz">
                ...
                <div className="box-quiz">
                    ...
                    {context.questions[countQue].image && (
                        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '1rem' }}>
                            <img
                                src={context.questions[countQue].image}
                                alt="Question"
                ...
                <div className="footer-container-boxQuiz">
                    <h5 className="numb-questions">{context.questions[countQue].numb} из {context.questions.length}</h5>
    ...
    function selectedOption(e) {
        ...
        if (e.target.textContent !== correctAns) {
            ...
            e.target.insertAdjacentHTML("beforeend", "<i></i>");
        } else {
