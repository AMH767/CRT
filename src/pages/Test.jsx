    ...
    <div className="container">
      <div className="row mb-5">
        <div className="col-12 text-center">
          <h2 className="section-title mb-3">Тесты</h2>
        </div>
      </div>
      <div className="row">
        <div className="bobi col-md-6 col-lg-4 mb-4 mb-lg-4">
          <div className="h-entry">
            ...
            /> */}
            <h2>
              <a href="/boxQuiz">Графические Паттерны: Часть 1</a>
            </h2>
...
Тест на знание основ графических паттернов...
        ...
        <div className="bobi col-md-6 col-lg-4 mb-4 mb-lg-4">
          <div className="h-entry">
            ...
            /> */}
            <h2>
              <a href="/boxQuiz">Графические Паттерны: Часть 2</a>
            </h2>
        ...
        <div className="bobi col-md-6 col-lg-4 mb-4 mb-lg-4">
          <div className="h-entry">
            ...
            /> */}
            <h2>
              <a href="/boxQuiz">Графические Паттерны: Часть 3</a>
            </h2>
            {/* <div class="meta mb-4">James Phelps <span class="mx-2">•</span> Jan 18, 2019<span class="mx-2">•</span> <a href="#">News</a></div> */}
            <p>
              Тест на знание основ графических паттернов...
